        ...
        <div class="product-information">
            ...
            <span>
               ...
               <div class="alert alert-success">
                 <strong>Stok </strong><?php echo e($product->stok); ?> Item
               </div>
                  
               <label>Quantity:</label>
               <div class="form-group">
                <input type="number" name="quantity" class="item_quantity" min="1" max="<?php echo e($product->stok); ?>"  value="1">
    ...
    <div class="tab-content">
        <div class="tab-pane fade active in" id="reviews" >
            <div class="col-sm-12">
                ...
                <hr>
                <p>Berat : <?php echo e($product->berat); ?> gram</p>
            </div>
        </div>
