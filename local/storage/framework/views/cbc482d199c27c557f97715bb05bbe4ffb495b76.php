...
<link rel="shortcut icon" href="<?php echo e(asset('favicon.ico')); ?>"/> 
    ...
    <title>BeliSob | Online Shop Murah</title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/jquery-ui.structure.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/jquery-ui.theme.min.css')); ?>">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo e(url('/akun')); ?>"><i class="fa fa-user"></i> Akun</a></li>
                    <?php if (\Entrust::hasRole('admin')) : ?>
                    <li><a href="<?php echo e(route('admin.products.index')); ?>">Product</a></li>
                    <li><a href="<?php echo e(url('/admin/report')); ?>">Laporan Transaksi</a></li>
