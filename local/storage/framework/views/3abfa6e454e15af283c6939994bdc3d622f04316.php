    ...
    <div id="menu1" class="tab-pane fade in active">
		...
		<div class="panel-body">
			...
			<div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
				...
				<div class="col-md-6">
					<input required="" type="text" class="form-control" value="<?php echo e((Auth::user()->name)); ?>" name="name" placeholder="Nama">
				</div>
				<?php echo Form::hidden('formid', $formid); ?>
			...
			<div class="form-group<?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
				...
				<div class="col-md-6">
					<input required="" type="number" class="form-control" name="phone" value="<?php echo e($phone); ?>" placeholder="Nomor Handphone">
				</div>
			</div>
			...
			<div class="form-group<?php echo e($errors->has('address') ? ' has-error' : ''); ?>">
				...
				<div class="col-md-6">
					<input required="" type="text" class="form-control" name="address" value="<?php echo e($address); ?>" placeholder="Alamat Lengkap">
				</div>
			</div>
			...
			<div  class="form-group<?php echo e($errors->has('province') ? ' has-error' : ''); ?>">
				...
				<div  class="col-md-6">
					<input required="" type="text" class="form-control" name="province" value="<?php echo e($province); ?>" placeholder="Provinsi">
				</div>
			</div>
			...
			<div class="form-group<?php echo e($errors->has('postal_code') ? ' has-error' : ''); ?>">
				...
				<div class="col-md-6">
					<input required="" type="number" class="form-control" name="postal_code" value="<?php echo e($postal_code); ?>" placeholder="Kode Pos">
				</div>
			</div>
