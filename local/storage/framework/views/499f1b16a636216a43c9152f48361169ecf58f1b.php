						...
						<table class="table table-hover table-striped">
							...
							<tr>
								...
								<td>
									...
									<input type="hidden" name="nameUser" value="<?php echo e(App\User::find($list->id_users)->name); ?>">
									<input type="hidden" name="email" value="<?php echo e(App\User::find($list->id_users)->email); ?>">
