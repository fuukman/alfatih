                        ...
                        <div class="col-md-12">
                            ...
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#add_pro" data-toggle="tab">Ubah Kategori</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="add_pro">
                                        <form role="form" method="post" files="true" action="<?php echo e(route('admin.categori.update',$category->id)); ?>" enctype="multipart/form-data">
                                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                            <input type="hidden" name="_method" value="PUT">

                                            <div class="form-group">
                                                <label>Status Kategori</label>
                                                <select id="form-field-select-3" required="" class="form-control search-select" name="status">
