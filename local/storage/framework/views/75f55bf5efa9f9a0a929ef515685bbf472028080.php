...
<link href="<?php echo e(asset('theme/backend/plugins/datatables/dataTables.bootstrap.css')); ?>" rel="stylesheet" type="text/css" />
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
<?php $__env->stopSection(); ?>
<?php $__env->startSection('scripts'); ?>
<script src="<?php echo e(asset('theme/backend/plugins/datatables/jquery.dataTables.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('theme/backend/plugins/datatables/dataTables.bootstrap.js')); ?>" type="text/javascript"></script>
...
<!-- <script src="https://almsaeedstudio.com/themes/AdminLTE/plugins/morris/morris.css"></script> -->
        ...
        <script src="<?php echo e(url('theme/backend/plugins/fastclick/fastclick.js')); ?>"></script>
        ...
        <script src="<?php echo e(url('theme/backend/plugins/flot/jquery.flot.min.js')); ?>"></script>
        <script src="<?php echo e(url('theme/backend/plugins/flot/jquery.flot.resize.min.js')); ?>"></script>
        <script src="<?php echo e(url('theme/backend/plugins/flot/jquery.flot.pie.min.js')); ?>"></script>
        <script src="<?php echo e(url('theme/backend/plugins/flot/jquery.flot.categories.min.js')); ?>"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
        <script src="<?php echo e(url('theme/backend/plugins/morris/morris.min.js')); ?>"></script>
        <script src="<?php echo e(url('theme/backend/plugins/knob/jquery.knob.js')); ?>"></script>
<script>
    /* jQueryKnob */
     ...
     <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <?php foreach($stok as $stk): ?>
                <div class="col-md-1">
                  <input type="text" class="knob" value="<?php echo e($stk->stok); ?>" data-width="60" data-height="60" data-fgColor="#3c8dbc">
                  <p style="text-align: center;"><?php echo e($stk->name); ?></p>
                </div>
                <?php endforeach; ?>
                <!-- ./col -->
