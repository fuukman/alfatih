                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="add_pro">
                                        <form role="form" method="post" action="<?php echo e(route('admin.products.update',$product->id)); ?>" files="true" enctype="multipart/form-data">
                                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                            <input type="hidden" name="_method" value="PUT">
                                            <div class="form-group">
                                                <label>Category</label>
                                                <select required="" id="form-field-select-3"  class="form-control search-select" name="id_cat">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="desc" class="form-control"> <?php echo e($product->desc); ?></textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" name="stok" class="form-control" value=" <?php echo e($product->stok); ?>">
                                            </div>
                                             <div class="form-group">
                                                <label>Berat</label>
                                                <input type="text" name="berat" class="form-control" value=" <?php echo e($product->berat); ?>">
                                            </div>
                                            <div class="form-group">
