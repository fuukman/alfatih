                            ...
                            <div class="nav-tabs-custom">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="add_pro">
                                        <form role="form" method="post" action="{{route('admin.products.update',$product->id)}}" files="true" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" name="stok" class="form-control" value=" {{$product->stok}}">
                                            </div>
                                             <div class="form-group">
                                                <label>Berat</label>
                                                <input type="text" name="berat" class="form-control" value=" {{$product->berat}}">
                                            </div>
                                            <div class="form-group">
